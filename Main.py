...
class Main(QDialog):
    ...
    def __init__(self):
        ...
        pixmap = QtGui.QPixmap('images/task.png')
        ...
        if validation_of_data(self.tableWidget):
            ...
            while i < self.tableWidget.rowCount():
                ...
                try:
                    ...
                    sk = round(math.sin(int(item_minus_1)) - math.cos(int(item)))

                    a = int(str(self.textEdit_a.toPlainText()))
                    x = int(str(self.textEdit_x.toPlainText()))
